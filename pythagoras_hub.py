...
def print_banner():
    """Выводит ASCII-арт баннер в идеальном триколоре."""
    # Единый логотип, разделенный по 2 строки на цвет
    white_part = (
        " ██████╗ ██╗   ██╗████████╗██╗  ██╗ █████╗  ██████╗  ██████╗ ██████╗  █████╗ ███████╗\n"
        " ██╔══██╗╚██╗ ██╔╝╚══██╔══╝██║  ██║██╔══██╗██╔════╝ ██╔═══██╗██╔══██╗██╔══██╗██╔════╝"
    )
    ...
    banner_text = Text()
    banner_text.append(white_part + "\n", style="bold white")
    banner_text.append(blue_part + "\n", style="bold blue")
    banner_text.append(red_part, style="bold red")
