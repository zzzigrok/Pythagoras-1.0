...
python prep_math.py
```
*Это создаст файл `input_math.txt` с 600,000 примеров разной сложности.*
...
1. **Вход в чат** — начать диалог с моделью (требуются веса).
2. **Обучение** — запустить процесс обучения с нуля.
3. **История** — просмотреть логи прошлых сессий.
